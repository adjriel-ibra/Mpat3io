...
<body>
    <div class="container">
        ...
        <form action="<?= site_url('user/login/register'); ?>" method="POST">
            <div class="mb-3 input-icon">
                <img src="<?= base_url('asset/icon/ic_user.png'); ?>" class="icon" alt="user Icon">
                <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Anda" required>
            </div>
            <div class="mb-3 input-icon">
                <img src="<?= base_url('asset/icon/ic_telp.png'); ?>" class="icon" alt="telp Icon">
        ...
        <div class="form-text">
            <span>Sudah punya akun? <a class="link" href="<?=base_url('index/masuk')?>">MASUK</a></span>
        </div>
    </div>
