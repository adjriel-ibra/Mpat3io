                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-8 col-md-10">
                                <div class="card-body history-card-body" style="background-color:#FFFCFA;">
                                    ...
                                    <a class="btn btn-sm text-center-header" href="<?=base_url('admin/dashboard/detail_admin/'.$p->id_pesanan)?>" style="background-color:#FF6B35; margin-top: 5px; font-size: 0.8rem; padding: .25rem .5rem;">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
