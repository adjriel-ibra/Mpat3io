...
<body>
    ...
    <main class="container">
        ...
        <form action="<?= base_url('admin/dashboard/update_profil') ?>" method="post">
            ...
            <div class="profile-item">
                ...
                <input type="text" name="username" id="username" class="form-control form-control-custom" value="<?= $mitra->username ?>" required>
            </div>

            <div class="profile-item">
                <label for="nama_mitra" class="profile-label">Nama Mitra</label>
                <input type="text" name="nama_mitra" id="nama_mitra" class="form-control form-control-custom" value="<?= $mitra->nama_mitra ?>" required>
            </div>

            <div class="profile-item">
                <label for="email_mitra" class="profile-label">Email</label>
                <input type="email" name="email_mitra" id="email_mitra" class="form-control form-control-custom" value="<?= $mitra->email_mitra ?>" required>
            </div>

            <div class="profile-item" style="border-bottom: none;"> 
                <label for="alamat" class="profile-label">Alamat</label>
                <input type="text" name="alamat" id="alamat" class="form-control form-control-custom" value="<?= $mitra->alamat ?>" required>
            </div>
